...
extern  unsigned char SD_PlaySound(soundnames sound);
...
extern  unsigned char SD_MusicPlaying(void);
extern  unsigned char SD_SetSoundMode(SDMode mode);
extern  unsigned char SD_SetMusicMode(SMMode mode);
extern  int    SD_SoundPlaying(void);
